...
/**
 * Maps generic attack facts from Quick Duel to the canonical Location
 * predicate vocabulary. This adapter contains no card-specific semantics.
 */
export function structuredLocationAttackForHost(
  card: LocationCardLike,
  context: AttackHostContext,
) {
